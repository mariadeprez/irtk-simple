...
public:
  ...
  virtual void BStep();
  virtual void BStepGD(int iteration);
...
public:
  ...
  /// Execute one iteration and return log likelihood for GMM
  virtual double IterateGMMGD(int iteration,bool equal_var, bool uniform_prior);
  ...
  /// Set the bias to an image 
  virtual void SetBias(irtkRealImage &);
...
inline void irtkEMClassificationBiasCorrection::SetBias(irtkRealImage &bias)
{
  _bias=bias;
}
